...
def main(config):
    ...
    props_train = props[:176261]
    props_val = props[176261:]

    # IF USING CHO DATASET, USE 176261 INSTEAD OF 139910 BELOW!!!
    props_masked, mask = perm_mask(props) # mask is 1 if masked, otherwise 0
    props_masked_train = props_masked[:176261]
    props_masked_val = props_masked[176261:]
    mask_train = mask[:176261]
    mask_val = mask[176261:]
    # Setup DataLoader
