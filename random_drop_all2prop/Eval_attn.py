...
if __name__ == '__main__':
    ...
    config["data_path"] = os.path.join(script_directory, 'large_property_combined.csv')
    config["model_file"] = os.path.join(script_directory, 'model_14.py')
    config["outlier_bound_fp"] = os.path.join(script_directory, 'outlier_bounds.json')
    main(config)
